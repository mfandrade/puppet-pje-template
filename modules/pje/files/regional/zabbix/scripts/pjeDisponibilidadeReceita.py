...
class DisponibilidadeServicoWebService:
    def __init__(self, url="www.cnj.jus.br"):
        ConfigurarAmbiente()
        self._url = 'https://' + url + '/testeReceitaFederal/wsdl/proxyReceita.wsdl'
    ...
    def conectar(self):
        try:
            ...
            returnSoap = client.service.ConsultarCPFP3(self._CPF, self._CPF)
            nome = returnSoap.PessoaPerfil3[0].Nome
